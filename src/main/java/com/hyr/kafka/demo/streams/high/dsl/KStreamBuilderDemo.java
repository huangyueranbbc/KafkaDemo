...
public class KStreamBuilderDemo {
    ...
    public static void main(String[] args) {
        ...
        KStream<String, String> source1 = builder.stream("my-input-topic1");
        ...
        KTable<String, String> source2 = builder.table("my-input-topic2", "query_my_input_topic");
        ...
        GlobalKTable<String, String> source3 = builder.globalTable("my-input-topic3", "my_input_topic_global_store");
